...
public class RecordData : MonoBehaviour
{
    ...
    // what was actually played, regardless of any subsequent state changes.
    //
    // Data sources:
    //   evt            → stimulus properties (durations, comparison type, onset time)
    ...
    public void extractEventSummary(experimentParameters.StimulusEvent evt)
    {
        ...
        //   standardDurationMs, comparisonDurationMs, comparisonType, toneFrequencyHz,
        //   targOnset, clickOnset, reactionTime,
        ...
        string data =
                  ...
                  experimentParameters.trialD.blockType + "," +         // trial context (walk speed)
                  evt.standardDurationMs + "," +                        // stimulus data (from event)
                  evt.comparisonDurationMs + "," +                      // stimulus data
                  evt.comparisonType + "," +                            // stimulus data (Shorter/Longer)
                  evt.toneFrequencyHz + "," +                           // stimulus data
                  evt.onsetTime + "," +                                 // stimulus data
                  experimentParameters.trialD.clickOnsetTime + "," +    // response data
                  reactionTime + "," +
                  experimentParameters.trialD.targResponse + "," +      // response: 1=longer, 0=shorter
                  experimentParameters.trialD.targCorrect;              // 1=correct, 0=incorrect
