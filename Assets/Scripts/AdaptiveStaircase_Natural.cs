// DISABLED: Replaced by AdaptiveStaircase.cs (single script, multiple conditions).
// Remove the AdaptiveStaircaseNatural component from the GameObject in the Inspector.
#if false
using UnityEngine;
